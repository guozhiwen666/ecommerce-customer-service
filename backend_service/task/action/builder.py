...
from backend_service.task.action.base import Action
from backend_service.task.action.builtin.listener import ActionListener
from backend_service.task.action.builtin.response import ActionResponse
from backend_service.task.action.register import ActionRegister
from backend_service.task.action.runner import ActionRunner
...
def registry_customer_action(action_runner: ActionRunner):
    ...
    Returns:
    """
    customer_action_package = importlib.import_module("backend_service.task.action.customer")
