...
from backend_service.task.flows.flows import FlowList, FlowSlot, Flow
from backend_service.task.flows.steps import FlowStep, CollectFlowStep
...
class FlowLoader:
    ...
    def load_multi_yaml(self, paths: list[Path]) -> FlowList:
        ...
        return FlowList(slots=final_slots, flows=final_flows)
    ...
    def _load_flows(self, flow_dict: dict[str, Any], loaded_slots: dict[str, FlowSlot]) -> list[Flow]:
