from backend_service.domain.messages import UserMessage, MessageType, FocusedObject, BotMessage
from backend_service.domain.state import Turn
...
class ChatHistoryBuilder:
    ...
    @classmethod
    def build_bot_message_str(cls, bot_message: BotMessage):
