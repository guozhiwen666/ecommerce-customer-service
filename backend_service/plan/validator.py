...
from backend_service.plan.turn_plan import TurnPlan, TurnPlanValidatedResult, ClarifyReason, TaskTurnPlan, \
    KnowledgeTurnPlan
from backend_service.task.commands.command import StartFlowCommand, SetSlotsCommand, CancelFlowCommand, \
    ResumedFlowCommand
...
class TurnPlanValidator:
    ...
    def _validate_task_track(self, task: TaskTurnPlan, flow_list: FlowList) -> TurnPlanValidatedResult:
        """
        职责：校验task轨道
