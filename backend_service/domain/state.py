...
from backend_service.domain.contexts import TaskContext, SystemContext
from backend_service.domain.messages import UserMessage, BotMessage, FocusedObject
...
class DialogueState:
    ...
    def from_dict(cls, data: dict[str, Any]) -> "DialogueState":
        return cls(
            ...
            active_system_task=SystemContext.from_dict(
                data["active_system_task"]) if data["active_system_task"] is not None else None,
