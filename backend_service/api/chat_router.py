...
from backend_service.api.dependencies import DialogueStateServiceDep
from backend_service.api.schemas import ChatResponse, ChatRequest, ChatBotMessage, ChatObject
from backend_service.domain.messages import UserMessage, MessageType, FocusedObject, ProcessedResult
    ...
    return ChatResponse(
        ...
        messages=[ChatBotMessage(
            ...
            object=ChatObject(
             ...
             for bot_message in processed_result.message]
    )